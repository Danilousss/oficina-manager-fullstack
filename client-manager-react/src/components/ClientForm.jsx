      ...
      <form onSubmit={handleSave} className="card-body row g-3">
        ...
        <div className="col-md-4">
          ...
          <input 
            type="text" 
            required 
            className={`form-control ${errors.carro ? 'is-invalid' : ''}`} 
            placeholder="Modelo do carro" 
            value={newClient.carro} 
        ...
        <div className="col-md-3">
          ...
          <input 
            ...
            required 
            min="0"
            className={`form-control ${errors.quilometragem ? 'is-invalid' : ''}`} 
            placeholder="Ex: 180000" 
            value={newClient.quilometragem} 
        ...
        <div className="col-md-3">
          ...
          <select 
            required 
            className={`form-select ${errors.formaPagamento ? 'is-invalid' : ''}`} 
            value={newClient.formaPagamento} 
        ...
        <div className="col-12">
          ...
          <textarea 
            ...
            rows="2" 
            value={newClient.serviceDescription} 
            onChange={e => { setNewClient({...newClient, serviceDescription: e.target.value}); setErrors({...errors, serviceDescription: null}); }}>
          </textarea>
